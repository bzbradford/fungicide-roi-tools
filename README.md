...
This tool helps farmers and agronomists evaluate the economic potential of fungicide applications for field crops by estimating the expected net benefit of fungicide applications based on economic modeling of multi-year, multi-location field trial results conducted across the US Midwest. Estimates are based on historical trial data and actual results may vary. These tools are offered free of charge and the developers, associated institutions and funding agencies cannot guarantee accuracy. Users assume all risk. Consult with your local extension professionals before making spray decisions.
...
* **Expected net benefit:** Estimated profit or loss: `yield_benefit * price − treatment_cost`
...
* **Breakeven cost:** Maximum program + application cost that still expects to break even based on the expected benefit of the program and expected sale price
...
* Negative values (red shaded area) indicate expected loss

#### Assumptions

* Yield response based on linear regression of field trial data
* Disease severity affects yield loss proportionally
